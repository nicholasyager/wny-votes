...
host     : '127.0.0.1',
user     : "root",
password : "19Nicholasyagerhelium(#",
database : "wny_votes"
});


connection.on('err', function (err) {
	console.log("MySQL error occured."+err+"\nReconnecting.");
	connection.connect();
});
...
app.post('/register', jsonParser, function(req, res) {
		...
		if (req.body.birthday) {
			formData["BirthMonth"] = req.body.birthday.substring(0,2);
			formData["BirthDay"] = req.body.birthday.substring(3,5);
			formData["BirthYear"] = req.body.birthday.substring(6,10);
		}
